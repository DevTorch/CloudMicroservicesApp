...
public interface AuthenticationServiceFeignClient {
    ...
    ResponseEntity<AuthenticationResponseDTO> getAccountById(@PathVariable("accountId") Long accountId);

    @GetMapping("/{accountId}/exists")
    Boolean isAccountExists(@PathVariable("accountId") Long accountId);
